...
public class RentalModel{
    ...
    public int createIdrental(){
        ...
        try{
            ...
            //3. Write the SQL
            String sql = "INSERT INTO rental_machine(id) VALUES (NULL)";
            ...
            //8. Loop while there is a register
            while(objRest.next()){
                aux = objRest.getInt(1);
            }

            JOptionPane.showMessageDialog(null, "Rental_machine insertion was successful");
        }catch (SQLException e){
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
